...
public class RopaController {
    ...
    public void agregarRopa(Ropa ropa) {
        String sql = "INSERT INTO ropa (modelo, nombre, precio, talla, color, categoria_id, imagen, descripcion) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        try (Connection con = ConexionDB.getConexion();
            ...
            ps.setString(8, ropa.getDescripcion());
    ...
    public ArrayList<Ropa> obtenerRopaPorCategoria(String nombreCategoria) {
        ...
        String sql = "SELECT r.id, r.modelo, r.nombre, r.precio, r.talla, r.color, r.imagen, r.descripcion, " +
    ...
    public void editarRopaPorId(Ropa ropa) {
        String sql = "UPDATE ropa SET nombre = ?, precio = ?, talla = ?, color = ?, categoria_id = ?, imagen = ?, descripcion = ? WHERE id = ?";
        try (Connection con = ConexionDB.getConexion();
             PreparedStatement ps = con.prepareStatement(sql)) {
    ...
    public ArrayList<Ropa> buscarRopa(String nombre, String modelo, Double precio, String color) {
        ...
        StringBuilder sql = new StringBuilder(
            "SELECT r.id, r.modelo, r.nombre, r.precio, r.talla, r.color, r.imagen, r.descripcion, " +
            "c.id AS cat_id, c.nombre AS cat_nombre, c.descripcion AS cat_descripcion, c.foto AS cat_foto " +
